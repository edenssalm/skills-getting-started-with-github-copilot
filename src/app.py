...
activities = {
    ...
    "Swimming Club": {
        "description": "Improve swimming technique and endurance in pool sessions",
    ...
    "Drama Club": {
        "description": "Develop acting skills, rehearse scenes, and perform for the school",
    ...
    "Science Club": {
        "description": "Explore scientific experiments and prepare for science fairs",
